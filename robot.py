...
class two2_robot:
    ...
    @staticmethod
    def get_colored_plt(hex, hex2, hex3 = '#D6D6D6',figsize=(6, 6)):
    ...
    def get_c_space_figure(self, fig, ax, th1, th2): 
        pi = np.pi
        self.set_axes(ax,xlim=[-2*pi,2*pi], ylim=[-2*pi,2*pi], xlabel='$\Theta_1$', ylabel='$\Theta_2$')
        self.th1 = th1
        self.th2 = th2
        # plot c space
        ax.scatter(th1,th2, color = 'r')
        return fig
